...
pub fn register_default_options(type_registry: &mut TypeRegistry) {
    ...
    {
        #[rustfmt::skip]
        insert_options_struct::<bevy_light::prelude::AmbientLight>(
            type_registry,
            &[
        ...
        insert_options_struct::<bevy_light::prelude::PointLight>(
            type_registry,
            &[
        ...
        #[rustfmt::skip]
        insert_options_struct::<bevy_light::prelude::DirectionalLight>(
            type_registry,
            &[
